  ...
  return (
    <View
      ...
      <View
        ...
        <View style={{flexDirection: 'row', alignItems: 'center', gap: 5}}>
          ...
          <Text style={[FONTS.fontMedium, {fontSize: 20, color: colors.title}]}>
            Click <Text style={{color: COLORS.primary}}>Cart</Text>
          </Text>
        </View>
        <TouchableOpacity
          style={{
      ...
      <View style={{}}>
        ...
        <View
          ...
          <TouchableOpacity
            ...
            <Text
              style={[
                FONTS.fontMedium,
                {fontSize: 14, color: show ? colors.text : COLORS.primary},
              ]}>
              Enter Mobile Number
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            ...
            <Text
              style={[
                FONTS.fontMedium,
                {fontSize: 12, color: show ? COLORS.primary : colors.text},
              ]}>
              Use Email Id
            </Text>
          </TouchableOpacity>
        ...
        <View style={{paddingTop: 10}}>
          <Text
            ...
            By continuing, you agree to AmazMart's{' '}
      ...
      <View style={{marginTop: 30}}>
        <Button title="Continue" onPress={() => moresheet3.current.close()} />
      </View>
    </View>
  );
};
