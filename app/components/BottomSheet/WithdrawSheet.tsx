  ...
  return (
    <>
      <View style={[GlobalStyleSheet.container]}>
        ...
        <View style={GlobalStyleSheet.inputGroup}>
          <Input defaultValue="0454547154648467871787156558" />
          <TouchableOpacity
            style={{
              height: 48,
              width: 48,
        ...
        <View style={GlobalStyleSheet.inputGroup}>
          <Text style={[FONTS.fontSm, {color: colors.text, marginBottom: 6}]}>
            Available:{' '}
            <Text style={{color: colors.title}}>56154.4854871BTC</Text>
          </Text>
        ...
        <View
          ...
          <Text
            style={[
              ...
              {color: colors.title, lineHeight: 32},
            ]}>
            0.00BTC
          </Text>
          <Text style={[FONTS.font, {color: COLORS.primaryText}]}>
            Amount Received
          </Text>
        </View>
        <View
