    ...
    <View
      ...
      <TouchableOpacity
        ...
        <FeatherIcon
          size={20}
          color={
            productList ? (theme.dark ? COLORS.card : '#8F8F8F') : COLORS.card
          }
          name={'minus'}
        />
      </TouchableOpacity>
      ...
      <TouchableOpacity
        ...
        <FeatherIcon
          size={20}
          color={
            productList ? (theme.dark ? COLORS.card : '#4A3749') : COLORS.card
          }
          name={'plus'}
        />
      </TouchableOpacity>
