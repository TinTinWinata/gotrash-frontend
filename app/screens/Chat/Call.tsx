    ...
    <View style={{backgroundColor: '#80909C', flex: 1}}>
      <View style={GlobalStyleSheet.container}>
        ...
        <View
          ...
          <Text
            style={{...FONTS.fontSemiBold, ...FONTS.h4, color: COLORS.title}}>
            Emily Johnson
          </Text>
          <Text
            style={{
      ...
      <View style={{position: 'absolute', bottom: 30, left: 0, right: 0}}>
        <View
            ...
            <View
              style={[
                GlobalStyleSheet.background,
                {
                  height: 50,
                  width: 50,
                  backgroundColor: show1 ? 'rgba(0,0, 0, 0.20)' : COLORS.card,
                },
              ]}>
              <Image
                style={[
                  GlobalStyleSheet.image,
                  {tintColor: show1 ? COLORS.white : COLORS.title},
                ]}
          ...
          <TouchableOpacity
            ...
            <View
              style={[GlobalStyleSheet.background, {height: 50, width: 50}]}>
              <Image
                style={[GlobalStyleSheet.image, {tintColor: COLORS.white}]}
                source={show ? IMAGES.audio : IMAGES.audiomute}
              />
            </View>
          </TouchableOpacity>
        </View>
